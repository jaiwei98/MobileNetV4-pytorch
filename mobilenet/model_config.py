...
def mhsa(num_heads, key_dim, value_dim, kv_strides):
    # if px == 24:
    #     kv_strides = 2
    # elif px == 12:
    #     kv_strides = 1
...
MNV4HybridConvMedium_BLOCK_SPECS = {
    ...
    "layer3": {
        ...
        "block_specs": [
            ...
            [160, 160, 0, 0, True, 1, 2],
            [160, 160, 3, 3, True, 1, 4],
            [160, 160, 3, 5, True, 1, 4, mhsa(4, 64, 64, 2)],
            [160, 160, 3, 3, True, 1, 4, mhsa(4, 64, 64, 2)],
            [160, 160, 3, 0, True, 1, 4, mhsa(4, 64, 64, 2)],
            [160, 160, 3, 3, True, 1, 4, mhsa(4, 64, 64, 2)],
            [160, 160, 3, 0, True, 1, 4]
        ]
    },
    "layer4": {
        ...
        "block_specs": [
            ...
            [256, 256, 3, 5, True, 1, 2],
            [256, 256, 0, 0, True, 1, 2],
            [256, 256, 0, 0, True, 1, 4, mhsa(4, 64, 64, 1)],
            [256, 256, 3, 0, True, 1, 4, mhsa(4, 64, 64, 1)],
            [256, 256, 5, 5, True, 1, 4, mhsa(4, 64, 64, 1)],
            [256, 256, 5, 0, True, 1, 4, mhsa(4, 64, 64, 1)],
...
MNV4HybridConvLarge_BLOCK_SPECS = {
    ...
    "layer3": {
        ...
        "block_specs": [
            ...
            [192, 192, 3, 5, True, 1, 4],
            [192, 192, 5, 3, True, 1, 4],
            [192, 192, 5, 3, True, 1, 4, mhsa(8, 48, 48, 2)],
            [192, 192, 5, 3, True, 1, 4, mhsa(8, 48, 48, 2)],
            [192, 192, 5, 3, True, 1, 4, mhsa(8, 48, 48, 2)],
            [192, 192, 5, 3, True, 1, 4, mhsa(8, 48, 48, 2)],
            [192, 192, 3, 0, True, 1, 4]
    ...
    "layer4": {
        ...
        "block_specs": [
            ...
            [512, 512, 5, 0, True, 1, 4],
            [512, 512, 5, 3, True, 1, 4],
            [512, 512, 5, 5, True, 1, 4, mhsa(8, 64, 64, 1)],
            [512, 512, 5, 0, True, 1, 4, mhsa(8, 64, 64, 1)],
            [512, 512, 5, 0, True, 1, 4, mhsa(8, 64, 64, 1)],
            [512, 512, 5, 0, True, 1, 4, mhsa(8, 64, 64, 1)],
            [512, 512, 5, 0, True, 1, 4]
        ]
